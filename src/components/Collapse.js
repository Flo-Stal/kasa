...
const Collapse = ({ collapseTitle, collapseInfo }) => { 
    ...
    //Le useState est initialisé à false car le collapse est défini comme étant fermé par défaut. Cela signifie qu'il faut cliquer sur le bouton pour l'ouvrir.
    const toggle = () => {
